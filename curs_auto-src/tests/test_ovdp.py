...
from spiders.bonds import bonds_match, generate_bonds, internal_payments
from spiders.bonds import colection_meta, bonds_income, update_auctions

from spiders.common_spider import get_tzinfo
from tests.data.ovdp import data, income_result_etalon, bonds_etalon, payments_etalon
